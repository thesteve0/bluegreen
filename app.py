...
def index():
    ...
    # Green - #008000
    # Blue - #0000FF
    response_string = "<html> <style> body {background-color: #0000FF;} </style> <body> <h1> <font color='white'> We are Living on the edge with Blue on: " + str(host)+ " </font> </h1> </body> </html>"
